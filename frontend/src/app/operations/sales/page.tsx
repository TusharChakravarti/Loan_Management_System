            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 overflow-hidden shadow-2xs transition-colors duration-200">
              <div className="p-6 border-b border-slate-100 dark:border-slate-800">
                <h2 className="text-base font-extrabold text-slate-900 dark:text-white tracking-tight">
                  Pending Application Queue ({loans.length})
                </h2>
              ...
              {loading ? (
                ...
                <EmptyState
                  title="Sales Queue Empty"
                  description="There are currently no pending loan applications awaiting preliminary Sales review."
                  icon="✨"
                />
              ) : (
